...
//    */
// void RMQHandler::onReady(AMQP::TcpConnection* connection)
// {
//   DBG(RMQHandler,
...
bool RMQInterface::connect(uint64_t rId,
                           std::string rmq_name,
