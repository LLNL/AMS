...
class TestReader(unittest.TestCase):
    ...
    def _cmp(self, writer_cls, reader_cls, fn):
        ...
        self.assertTrue(np.array_equal(read_inputs, inputs), msg=f"Writting with {writer_cls} and reading with {reader_cls}")
        self.assertTrue(np.array_equal(read_outputs, outputs), msg="Writting with {writer_cls} and reading with {reader_cls}")
